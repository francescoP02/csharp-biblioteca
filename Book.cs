...
public class Book : Document
{
    ...
    public Book(string isbn, int pages, string title, int year, string genre, bool available, string shelf, string author) : base(title, year, genre, available, shelf, author)
    {
        ISBN = isbn;
        Pages = pages;
    }
